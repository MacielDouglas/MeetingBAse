...
export const publishers = pgTable("publishers", {
  ...
  apuntes: text("apuntes"),
  celular: text("celular"),
  telefono: text("telefono"),
  email: text("email"),
  familiaId: uuid("familia_id"),
  cabezaFamilia: boolean("cabeza_familia").default(false),
  ministroCampo: text("ministro_campo"),
  siervo: boolean("siervo").default(false),
  anciano: boolean("anciano").default(false),
  oracion: boolean("oracion").default(false),
  presidenteEntreSemana: boolean("presidente_entre_semana").default(false),
  discursoEntreSemana: boolean("discurso_entre_semana").default(false),
  busquemosPerlas: boolean("busquemos_perlas").default(false),
  lecturaBiblia: boolean("lectura_biblia").default(false),
  empieceConversaciones: boolean("empiece_conversaciones").default(false),
  hagaRevisitas: boolean("haga_revisitas").default(false),
  hagaDiscipulos: boolean("haga_discipulos").default(false),
  expliqueCreencias: boolean("explique_crencas").default(false),
  discursoEnsenanza: boolean("discurso_ensenanza").default(false),
  ayudanteEnsenanza: boolean("ayudante_ensenanza").default(false),
  analisisAuditorio: boolean("analisis_auditorio").default(false),
  discursoAnalisis: boolean("discurso_analisis").default(false),
  ebc: boolean("ebc").default(false),
  lectorEbc: boolean("lector_ebc").default(false),
  sala: text("sala").default("todas"),
  presidenteFinSemana: boolean("presidente_fin_semana").default(false),
  conductorAtalaya: boolean("conductor_atalaya").default(false),
  lectorAtalaya: boolean("lector_atalaya").default(false),
  hospitalidad: boolean("hospitalidad").default(false),
